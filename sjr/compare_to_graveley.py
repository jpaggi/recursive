...
for line in sys.stdin:
	...
	if not overlap or not seen:
		print chrom, start, end, strand,  'novel'#, sample, entropy, seq1, seq2, strand, 'novel'
	else:
		print chrom, start, end, strand, 'graveley' #, sample, entropy, seq1, seq2, strand, 'graveley'
	# 	pass
	# else:
	# 	print seq1 + seq2
