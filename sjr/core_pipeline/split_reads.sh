...
python putative_ratchet_sjr.py $1 $2'/sjr.bed' $4

echo 'Finished extracting splice junction reads'

cat $2'/sjr.bed' | sort -k1,1 -k2n,3n | python group_introns.py - $2'/sjr_groups.bed' $3

echo 'made groups'

python seq_for_groups.py $2'/sjr_groups.bed' $5 $2'/sjr_seq.bed' $4

echo 'got recursive site sequences'

python assign_introns.py $2'/sjr_seq.bed' $6 > $2'/sjr_introns.bed'
